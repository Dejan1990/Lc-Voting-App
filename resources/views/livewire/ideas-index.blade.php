<div>
    <div class="filters flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-6">
        ...
        <div class="w-full md:w-2/3 relative">
            <input wire:model.debounce.1000ms="search" type="search" placeholder="Find an idea" class="w-full rounded-xl bg-white border-none placeholder-gray-900 px-4 py-2 pl-8">
    ...
    <div class="my-8">
        ...
        {{-- Ovim smo sredili pagination, nije radilo kad koristimo filter --}}
    </div>
</div>
