...
class VoteShowPageTest extends TestCase
{
    ...
    public function votes_count_shows_correctly_on_show_page_livewire_component()
    {
        ...
        //->assertSeeHtml('<div class="text-sm font-bold leading-none">5</div>');// testiranje html cesto je problematicno narocito ako cesto menjamo html, moramo da vodimo racuna i o razmaku izmedju class-a
        ->assertSet('votesCount', 5);
    }
