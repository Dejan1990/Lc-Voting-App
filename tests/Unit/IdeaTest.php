...
class IdeaTest extends TestCase
{
    ...
    /** @test */
    /*public function voting_for_an_idea_thats_already_voted_for_throws_exception() this is not need cause we use Livewire 2.6
    {
        $user = User::factory()->create();
    ...
    /** @test */
   /* public function removing_a_vote_that_doesnt_exist_throws_exception() this is not need cause we use Livewire 2.6
    {
        $user = User::factory()->create();
